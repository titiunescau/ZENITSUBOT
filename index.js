...
Bem Vindo Ao Grupo! Olhe As Regras Do grupo Para Não Ser Banido 
 ...
 ⚡ Zenitsu ⚡ `
	        ...
	        const grupo = await client.groupMetadata(anu.jid)
                ini_user = client.contacts[num]
                ini_img = await getBuffer(`https://api-exteam.herokuapp.com/api/goodbye?titulo=ADEUS&nome=${pushname}perfil=${psCAPA.link}=https://i.imgur.com/fbs4CDb.jpg&grupo=SAIU%20DO%20${encodeURIComponent(grupo.subject)}`)
