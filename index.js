...
Bem Vindo Ao Grupo! Olhe As Regras Do grupo Para Não Ser Banido 
 ...
 ⚡ Zenitsu ⚡ `
            ...
            if (anu.action == 'remove') {
                ini_user = client.contacts[num]
                ini_img = await getBuffer(`https://api-exteam.herokuapp.com/api/goodbye?titulo=ADEUS&nome=sender&perfil=${psCAPA.link}=https://i.imgur.com/mEGIfin.png&fundo=https://i.imgur.com/fbs4CDb.jpg&grupo=SAIU%20DE%&gpnome=${encodeURIComponent(mdata.subject)}`)
